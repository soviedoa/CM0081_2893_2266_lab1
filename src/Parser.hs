...
happyExpList = Happy_Data_Array.listArray (0,34) ([8960,4480,0,512,48,0,0,2,1,0,32770,0,6144,1,0,8960,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_myParser","program","termList","term","appTerm","aTerm","var","'('","')'","'.'","';'","'\9580\9559'","%eof"]
...
myParser tks = happyRunIdentity happySomeParser where
